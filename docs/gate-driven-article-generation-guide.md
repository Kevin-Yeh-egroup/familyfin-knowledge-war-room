...
來源 gate：gate-02-non-concept, gate-04-complexity, gate-08-structure
...
### stage-04-evidence-design 先設計數值與台灣資料怎麼進文章

來源 gate：gate-03-numeric-proof, gate-07-fact-and-policy
...
### stage-05-scenario-design 先設計生活場景，不要虛構誇張案例

來源 gate：gate-02-non-concept, gate-06-story-precision, gate-04-complexity
...
### stage-06-draft-contract 再開始生成純文字正文

來源 gate：gate-08-structure, gate-10-actionability
