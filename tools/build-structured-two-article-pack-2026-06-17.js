...
const articles = [
  {
    ...
    paragraphs: [
      ...
      "以下用俊豪和怡君兩個化名情境說明。這不是單一真實故事，而是把常見家庭收支狀況整理在一起。兩個人都遇到被資遣後的房租壓力，但卡住的地方不一樣。俊豪卡在幾天的時間差，怡君卡在接下來幾個月的收入缺口。先把一個狀況說完，再看另一個，會比較容易分辨自己家裡是哪一種。",
      "先看俊豪。他缺的是五號到十號這幾天。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "這不是單一真實故事，而是常見租屋家庭的情境整理。雅婷的薪水是每月42,000元，月底入帳。她每月房租18,000元，通常五號匯；信用卡12號扣8,000元；保費15號扣3,200元；水電瓦斯和手機大約2,200元；從五號到月底，食物、交通和孩子雜費至少還要13,000元。帳戶看到38,000元那一刻，她以為還能喘一下。可是把日期排出來，答案就完全不同。",
      "帳戶有錢，不代表那些錢都能用。",
